...
\begin{twentyshort}
    \twentyitemshort{Internship At Avi Networks}{ Upgraded logging packages in Go ($\times 5$ speedup) and did \newline automation using Terraform and Ansible, see \href{https://github.com/terraform-providers/terraform-provider-avi/pull/1}{this} and \href{https://github.com/avinetworks/avi-dev/pull/51590}{this}}
\end{twentyshort}
