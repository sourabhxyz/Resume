...
\begin{twentyshort}
    \twentyitemshort{Internship At Avi Networks}{ Upgraded logging packages in Go ($\times 5$ speedup) and did automation \newline using Terraform and Ansible, see \href{https://github.com/terraform-providers/terraform-provider-avi/pull/1}{this} and \href{https://github.com/avinetworks/avi-dev/pull/51590}{this}}
\end{twentyshort}
...
\begin{twenty} % Environment for a list with descriptions
    ...
    \twentyitem{Sem V}{\href{https://drive.google.com/file/d/18IxH5LJK9xS29oomh65dGCQQ1upMbeQu/view?usp=sharing}{Predicting Taxi Travel Time}}{ML}{Analysed various approaches to predict a trip's travel time with their pros and cons, given
